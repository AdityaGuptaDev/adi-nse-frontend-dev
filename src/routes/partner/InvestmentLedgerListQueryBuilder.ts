...
export class InvestmentLedgerListQueryBuilder {
  ...
  /** Main query combining CAM + KFin with UNION ALL */
  ...
  private camSelect(): string {
    return `
      SELECT 
        ...
        created_at,
        updated_at,
        'cam_investor_details_wbr9' AS source_table
  ...
  private kfinSelect(): string {
    return `
      SELECT 
        ...
        created_at,
        updated_at,
        'kfintech_investor_master' AS source_table
