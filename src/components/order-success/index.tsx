...
const OrderSuccessScreen = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 flex items-center justify-center p-4">
      <div className="w-full max-w-sm bg-[#111111] rounded-3xl overflow-hidden shadow-2xl shadow-emerald-100">
        ...
        <div className="bg-gradient-to-br from-emerald-800 via-emerald-700 to-teal-600 px-6 pt-7 pb-6 text-center relative overflow-hidden">
          ...
          <div className="relative inline-flex items-center justify-center mb-4">
            ...
            <div className="w-16 h-16 bg-[#111111] rounded-full flex items-center justify-center shadow-lg shadow-emerald-900/30">
              <CheckCircle2
          ...
          <p className="text-xl font-bold text-[#F9FAFB] tracking-tight">Order Placed!</p>
        ...
        <div className="px-5 py-5 space-y-3">
          ...
          <div className="flex items-center gap-3 bg-emerald-50 border border-emerald-100 rounded-2xl p-4">
            <div className="w-9 h-9 bg-gradient-to-br from-emerald-600 to-teal-600 rounded-xl flex items-center justify-center flex-shrink-0">
              <TrendingUp className="w-4 h-4 text-[#F9FAFB]" />
            </div>
            <div className="min-w-0">
              <p className="text-xs text-emerald-500 font-semibold uppercase tracking-widest">Scheme</p>
              <p className="text-sm font-bold text-[#F9FAFB] truncate">{orderDetails.schemeName}</p>
            </div>
          </div>

          {/* Amount + Type */}
          <div className="grid grid-cols-2 gap-2">
            <div className="bg-[#0A0A0A] border border-slate-100 rounded-2xl p-3.5">
            ...
            <div className="bg-[#0A0A0A] border border-slate-100 rounded-2xl p-3.5">
              ...
              <p className="text-lg font-extrabold text-[#F9FAFB] mt-0.5">{orderDetails.transactionType}</p>
            </div>
          </div>
          ...
          <div className="space-y-2.5">
            <div className="flex items-center gap-3">
              <div className="w-7 h-7 bg-[#1F1A1A] rounded-lg flex items-center justify-center flex-shrink-0">
                <Mail className="w-3.5 h-3.5 text-[#F59E0B]" />
              </div>
              <div className="min-w-0">
                <p className="text-xs text-slate-400 font-semibold">Email</p>
                <p className="text-xs font-semibold text-[#F9FAFB] truncate">{orderDetails.email}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs font-semibold text-[#F9FAFB]">{orderDetails.dateTime}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2">
                  <p className="text-xs font-semibold text-[#F9FAFB] font-mono truncate">{orderDetails.orderNumber}</p>
                  <button
                    onClick={handleCopy}
                    className={`flex-shrink-0 w-5 h-5 rounded-md flex items-center justify-center transition-colors ${copied ? 'bg-emerald-50 text-emerald-500' : 'bg-[#111111] text-slate-400 hover:bg-slate-200'}`}
                  >
          ...
          <div className="flex gap-2 pt-1">
            <button className="flex-1 bg-gradient-to-r from-emerald-600 to-teal-500 text-[#F9FAFB] text-xs font-bold py-2.5 rounded-xl flex items-center justify-center gap-1.5 active:scale-95 transition-transform">
