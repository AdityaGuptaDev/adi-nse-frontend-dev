        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-md p-4 border border-gray-200">
            ...
            <div className="space-y-3">
              ...
              {verification.aadhaar.value.length==14 && !verification.aadhaar.verified && (
                <div className="space-y-3">
                  <button
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-md p-4 border border-gray-200">
            <div className="space-y-4">
              ...
              {/* Email Section - Looks like a separate card below PAN */}
              <div className="bg-gray-50/60 rounded-lg p-3 border border-gray-200">
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center">
                    <div className={`w-8 h-8 rounded-lg flex items-center justify-center mr-3 ${
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <div>
                    ...
                    {isEditing.bank ? (
                      ...
                      <p className="px-3 py-2 bg-gray-50 rounded-lg border border-gray-200 text-sm">
                        {verification.bank.accountNumber ? maskAccountNumber(verification.bank.accountNumber) : 'Not available'}
                      </p>
                    )}
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-md p-4 border border-gray-200">
            <div className="flex items-center mb-3">
              ...
              <div>
                <h3 className="text-sm font-semibold text-gray-900">Are you and ARN Holder?</h3>
                <p className="text-gray-600 text-xs">
                  {/* ARN Holder Question moved here */}
