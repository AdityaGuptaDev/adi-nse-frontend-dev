    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      ...
      <main className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto text-center">
          {/* Hero Section */}
          <div className="mb-12">
            <CustomText className="text-4xl sm:text-5xl lg:text-6xl font-bold text-[#F9FAFB] mb-6">
              Welcome to{" "}
              <span className="text-primary">Vedant Asset</span>
            </CustomText>
            <CustomText className="text-xl sm:text-2xl text-[#9CA3AF] mb-8 max-w-3xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row gap-8 justify-center items-stretch mb-16">
            ...
            <div className="bg-[#111111] rounded-3xl p-8 shadow-xl border border-[#2A2A2A] hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 w-full lg:w-80 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <CustomText className="text-2xl font-bold text-[#F9FAFB] mb-4 text-center">
                  Become an Investor
                </CustomText>
                <CustomText className="text-[#9CA3AF] mb-6 text-center leading-relaxed">
                ...
                <ul className="space-y-2 mb-8">
                  <li className="flex items-center text-sm text-[#9CA3AF]">
          ...
          <div className="bg-gradient-to-r from-primary/5 to-secondary/5 rounded-3xl p-8 mb-16">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <CustomText className="text-[#9CA3AF] text-sm">Happy Investors</CustomText>
              </div>
              <div className="text-center">
                <CustomText className="text-3xl font-bold text-primary mb-2">₹500Cr+</CustomText>
                <CustomText className="text-[#9CA3AF] text-sm">Assets Under Management</CustomText>
              </div>
              <div className="text-center">
                <CustomText className="text-3xl font-bold text-secondary mb-2">200+</CustomText>
                <CustomText className="text-[#9CA3AF] text-sm">Partner Network</CustomText>
              </div>
              <div className="text-center">
                <CustomText className="text-3xl font-bold text-orange-500 mb-2">50+</CustomText>
                <CustomText className="text-[#9CA3AF] text-sm">BC Partners</CustomText>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="text-center p-6 rounded-2xl bg-[#111111] shadow-lg border border-[#2A2A2A]">
              ...
              <CustomText className="text-xl font-semibold text-[#F9FAFB] mb-3">
                Trusted Platform
              </CustomText>
              <CustomText className="text-[#9CA3AF] leading-relaxed">
      ...
      {/* Footer */}
      <footer className="w-full py-6 px-4 sm:px-6 lg:px-8 border-t border-[#2A2A2A]">
