...
export default function DashboardSettingsPage() {
  ...
  const tabs = [
    ...
    { id: 'preferences', label: 'Preferences', icon: Settings, color: 'bg-gray-500' },
    { id: 'data', label: 'Data & Privacy', icon: Database, color: 'bg-indigo-500' },
  ...
  const ToggleSwitch = ({ enabled, onChange, size = 'normal' }:any) => {
    ...
    return (
      ...
      >
        <span
          className={`inline-block ${thumbClasses} transform rounded-full bg-white transition-transform duration-200 ${translateClasses} shadow-lg`}
        />
      </button>
    );
  };
  ...
  const SettingCard = ({ children, className = "" }:any) => (
    <div className={`bg-white rounded-xl border border-gray-100 p-6 hover:shadow-md transition-shadow duration-200 ${className}`}>
      {children}
    </div>
  );
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              <button className="px-6 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 shadow-lg">
                Save Changes
              </button>
            </div>
          </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
              <div className="p-4 bg-gradient-to-r from-gray-900 to-gray-800">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-white font-medium">{settings.firstName} {settings.lastName}</p>
              ...
              <nav className="p-2">
                {tabs.map((tab) => {
                  ...
                  return (
                    ...
                    >
                      <div className={`w-8 h-8 rounded-lg ${activeTab === tab.id ? tab.color : 'bg-gray-100'} flex items-center justify-center`}>
                ...
                <SettingCard>
                  ...
                  <div className="flex items-center space-x-6 mb-6">
                    ...
                    <div>
                      ...
                      <button className="mt-2 text-blue-600 text-sm hover:text-blue-700">Upload new photo</button>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {[
                      ...
                      <label key={index} className="flex items-center space-x-3">
                        <input type="checkbox" className="rounded border-gray-300 text-blue-600 focus:ring-blue-500" defaultChecked={index < 3} />
              ...
              <div className="space-y-6">
                <SettingCard>
                  <div className="flex items-center space-x-4 mb-6">
                    ...
                    <h2 className="text-xl font-semibold text-gray-900">Dashboard Layout</h2>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-4">Chart Type</label>
                ...
                <SettingCard>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="font-medium text-gray-900">Show Values</span>
                      <ToggleSwitch
                    ...
                    <div className="flex items-center justify-between">
                      <span className="font-medium text-gray-900">Hide Small Holdings</span>
                      <ToggleSwitch
              ...
              <div className="space-y-6">
                ...
                <SettingCard>
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-blue-400 transition-colors">
                    ...
                    <p className="text-sm text-gray-500">Supports CSV, Excel, JSON files up to 10MB</p>
              ...
              <div className="space-y-6">
                <SettingCard>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <span className="font-medium text-gray-900">Developer Mode</span>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <span className="font-medium text-gray-900">Beta Features</span>
                        <p className="text-sm text-gray-500">Try experimental features</p>
                      </div>
                      <ToggleSwitch
                ...
                <SettingCard>
                  <div className="flex items-center space-x-4 mb-6">
                    ...
                    <h2 className="text-xl font-semibold text-gray-900">Support & Feedback</h2>
                  </div>
