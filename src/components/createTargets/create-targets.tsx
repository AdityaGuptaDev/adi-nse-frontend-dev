...
const AssetDetails: React.FC<AssetDetailsProps> = ({ onBack, clientData }) => {
  return (
    <div className="bg-[#111111] text-sm min-h-screen">
      {/* Compact Header */}
      <div className="bg-[#111111] border-b border-[#2A2A2A] px-4 py-3">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
          <div className="text-3xl font-bold">
            <span className="text-orange-500">Vedant</span>
            <span className="text-black">Asset</span>
          </div>
          <div className="text-xs text-[#9CA3AF] sm:text-right">
        ...
        <div className="flex justify-center gap-3 mt-3 flex-wrap">
          {[
            ...
            { icon: <Send size={18} className="text-[#F59E0B]" />, label: "Email" },
            { icon: <MessageCircle size={18} className="text-green-600" />, label: "WhatsApp" },
            { icon: <Printer size={18} className="text-[#9CA3AF]" />, label: "Print" },
      ...
      <div className="bg-[#1A1A1A] px-4 py-2">
        <h1 className="text-sm font-semibold text-[#F9FAFB] text-center">Your Investment Targets</h1>
      </div>
      ...
      <div className="px-4 py-3">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2 mb-3">
          ...
          <div className="space-y-2">
            <div className="grid grid-cols-3 gap-2 items-baseline">
              <div className="font-medium text-[#F9FAFB] text-xs">Name:</div>
              <div className="col-span-2 text-xs">
                <div className="font-semibold">{clientData.name}</div>
                <div className="text-[#9CA3AF] text-2xs">(Group Head: -)</div>
              </div>
            </div>

            <div className="grid grid-cols-3 gap-2 items-baseline">
              <div className="font-medium text-[#F9FAFB] text-xs">Gender:</div>
              <div className="col-span-2 text-xs">-</div>
            </div>

            <div className="grid grid-cols-3 gap-2 items-baseline">
              <div className="font-medium text-[#F9FAFB] text-xs">Phone (Res):</div>
              <div className="col-span-2 text-xs">{clientData.phoneRes || '-'}</div>
            </div>

            <div className="grid grid-cols-3 gap-2 items-baseline">
              <div className="font-medium text-[#F9FAFB] text-xs">Phone (Off):</div>
              <div className="col-span-2 text-xs">{clientData.phoneOff || '-'}</div>
            </div>

            <div className="grid grid-cols-3 gap-2 items-baseline">
              <div className="font-medium text-[#F9FAFB] text-xs">Mobile:</div>
          ...
          <div className="space-y-2">
            <div className="grid grid-cols-3 gap-2 items-baseline">
              <div className="font-medium text-[#F9FAFB] text-xs">Address:</div>
              <div className="col-span-2 text-xs">{clientData.address}</div>
            </div>

            <div className="grid grid-cols-3 gap-2 items-baseline">
              <div className="font-medium text-[#F9FAFB] text-xs">City:</div>
              <div className="col-span-2 text-xs">{clientData.city}</div>
            </div>

            <div className="grid grid-cols-3 gap-2 items-baseline">
              <div className="font-medium text-[#F9FAFB] text-xs">Pincode:</div>
              <div className="col-span-2 text-xs">{clientData.pincode}</div>
            </div>

            <div className="grid grid-cols-3 gap-2 items-baseline">
              <div className="font-medium text-[#F9FAFB] text-xs">State:</div>
              <div className="col-span-2 text-xs">-</div>
            </div>

            <div className="grid grid-cols-3 gap-2 items-baseline">
              <div className="font-medium text-[#F9FAFB] text-xs">DOB:</div>
        ...
        <div className="border border-[#2A2A2A] rounded p-3 mb-3">
          <div className="text-center text-sm text-[#9CA3AF] py-2">
        ...
        <div className="flex justify-center gap-3 mb-3">
          <button 
            className="bg-green-500 hover:bg-green-600 text-[#F9FAFB] text-xs font-medium py-1.5 px-4 rounded transition-colors"
            onClick={onBack}
          >
            BACK TO CLIENT LIST
          </button>
        ...
        <div className="bg-[#0A0A0A] rounded-lg p-3">
          <h3 className="text-xs font-semibold text-[#F9FAFB] mb-2 text-center">Quick Actions</h3>
          <div className="flex justify-center gap-2 flex-wrap">
            <button 
              className="flex items-center text-xs bg-[#111111] hover:bg-[#111111] text-[#F9FAFB] border border-[#2A2A2A] px-2 py-1 rounded"
