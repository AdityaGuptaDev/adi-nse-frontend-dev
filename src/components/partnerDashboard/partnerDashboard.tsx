  ...
  const RemindLaterToast = () => {
    ...
    return (
      <div className="fixed top-6 right-6 z-50 animate-slide-in">
        <div className="bg-gradient-to-r from-[#F59E0B] to-[#B45309] rounded-xl p-4 shadow-2xl flex items-center space-x-3 border border-[#F59E0B]/30">
          <Clock className="w-5 h-5 text-white" />
          <div>
            <p className="text-sm font-semibold text-white">Reminder set! 🎯</p>
            <p className="text-xs text-[#FBBF24]">We'll remind you again in 24 hours</p>
          </div>
          <div className="absolute -top-1 -right-1 w-2 h-2 bg-[#FBBF24] rounded-full animate-ping"></div>
        </div>
      </div>
    );
  };
  ...
  return (
    <>
      <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
        <div className="bg-gradient-to-br from-[#111111] to-[#1F1A1A] rounded-3xl shadow-2xl max-w-md w-full transform transition-all animate-scale-in border border-[#2A2A2A]">
          <div className="p-8 border-b border-[#2A2A2A]">
            <div className="flex items-center space-x-4">
              <div className="relative">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#F59E0B] to-[#B45309] flex items-center justify-center shadow-lg">
                  {isLoading ? (
                ...
                <div className="absolute -top-2 -right-2 w-6 h-6 bg-gradient-to-r from-[#F59E0B] to-[#B45309] rounded-full flex items-center justify-center">
          ...
          {isLoading ? (
            <div className="p-8">
              <div className="flex flex-col items-center justify-center">
                <div className="relative">
                  <div className="w-12 h-12 border-3 border-[#F59E0B] border-t-transparent rounded-full animate-spin"></div>
                  <div className="absolute inset-0 flex items-center justify-center">
                    <Rocket className="w-6 h-6 text-[#F59E0B] animate-bounce" />
                  </div>
                </div>
                <p className="mt-4 text-[#9CA3AF] font-medium">Checking your status...</p>
              </div>
            </div>
          ) : (
            <>
              <div className="p-8">
                <p className="text-[#9CA3AF] mb-6 leading-relaxed">
                  Your partner onboarding is <span className="font-bold text-[#F59E0B]">almost complete</span>. Finish setup to access all dashboard features and start managing clients like a pro! 🚀
                </p>
                ...
                <div className="space-y-4 mb-8">
                  {[
                    ...
                    <div key={index} className="flex items-center space-x-3 animate-slide-up" style={{ animationDelay: `${index * 100}ms` }}>
                      <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#F59E0B]/20 to-[#B45309]/20 flex items-center justify-center">
                        <item.icon className="w-5 h-5 text-[#F59E0B]" />
                      </div>
                      <span className="text-sm font-medium text-[#F9FAFB]">{item.label}</span>
                      <CheckCircle className="w-5 h-5 text-[#10B981] ml-auto" />
                    </div>
                  ))}
                </div>

                <div className="bg-gradient-to-r from-[#F59E0B]/10 to-[#B45309]/10 rounded-xl p-5 border border-[#F59E0B]/20 mb-8">
                  <div className="flex items-start space-x-3">
                    <div className="w-10 h-10 rounded-xl bg-[#F59E0B]/20 flex items-center justify-center flex-shrink-0">
                      <Award className="w-5 h-5 text-[#F59E0B]" />
                    </div>
                    <div>
                      <p className="text-sm font-bold text-[#F59E0B]">Premium Access Awaits! 🏆</p>
              ...
              <div className="p-8 border-t border-[#2A2A2A] flex flex-col sm:flex-row gap-4">
                <button
                  onClick={handleRemindLater}
                  className="px-6 py-3.5 border border-[#2A2A2A] text-[#9CA3AF] rounded-xl font-semibold hover:bg-[#1F1A1A] transition-all duration-300 transform hover:scale-105 active:scale-95 flex-1 flex items-center justify-center"
                >
                ...
                <button
                  ...
                  className="px-6 py-3.5 bg-gradient-to-r from-[#F59E0B] to-[#B45309] text-white rounded-xl font-semibold hover:opacity-90 transition-all duration-300 transform hover:scale-105 active:scale-95 flex-1 flex items-center justify-center space-x-2 group"
                >
...
const MarketOverviewSkeleton = () => (
  <div className="bg-[#111111] rounded-2xl shadow-lg border border-[#2A2A2A] p-6 h-[400px] animate-pulse">
    <div className="flex items-center justify-between mb-4">
      <div className="h-7 w-40 bg-gradient-to-r from-[#2A2A2A] via-[#3A3A3A] to-[#2A2A2A] rounded-xl animate-shimmer bg-[length:200%_100%]"></div>
      <div className="h-5 w-24 bg-[#2A2A2A] rounded-lg"></div>
    </div>
    <div className="h-full bg-gradient-to-br from-[#1F1A1A] to-[#2A2A2A] rounded-xl animate-shimmer bg-[length:200%_100%]"></div>
  </div>
);
...
const QuickActions = () => {
  ...
  const actions = [
    {
      ...
      bgColor: "bg-gradient-to-br from-[#F59E0B]/10 to-[#B45309]/10",
      borderColor: "border-[#F59E0B]/30",
      hoverColor: "hover:shadow-[#F59E0B]/20",
    ...
    },
    {
      ...
      hoverColor: "hover:shadow-[#10B981]/20",
      onClick: () => {
  ...
  return (
    <div className="bg-[#111111] rounded-2xl shadow-xl border border-[#2A2A2A] p-6 h-full">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-3">
          <div className="p-2 rounded-xl bg-gradient-to-r from-[#F59E0B] to-[#B45309]">
            <Zap className="w-6 h-6 text-white" />
          </div>
          <div>
            <h2 className="text-xl font-bold text-[#F9FAFB]">Quick Actions</h2>
            <p className="text-sm text-[#9CA3AF]">Frequently used tools & shortcuts</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        {actions.slice(0, 6).map((action, index) => (
          <button
            key={index}
            className={`relative group ${action.bgColor} rounded-xl border ${action.borderColor} p-4 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#F59E0B] ${action.hoverColor}`}
            tabIndex={0}
          ...
          >
            ...
            <div className={`relative w-10 h-10 rounded-lg ${action.bgColor} border ${action.borderColor} flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300`}>
              ...
              <action.icon className={`w-5 h-5 text-[#F59E0B]`} />
            </div>

            <span className="text-xs font-semibold text-[#F9FAFB] text-center block group-hover:text-[#F59E0B] transition-colors">
              {action.label}
            </span>
...
const LiveMarketOverview = () => {
  ...
  return (
    <div className="relative bg-[#111111] rounded-2xl shadow-xl border border-[#2A2A2A] p-6 h-full overflow-hidden">
      <div className="absolute top-0 right-0 w-32 h-32 bg-[#F59E0B]/10 rounded-full -translate-y-16 translate-x-16 opacity-20"></div>
      <div className="absolute bottom-0 left-0 w-24 h-24 bg-[#B45309]/10 rounded-full translate-y-12 -translate-x-12 opacity-20"></div>
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-[#9CA3AF] mt-1">Real-time market data & trends</p>
            </div>
          </div>
...
const CalendarWidget = ({ userTypeId }: CalendarWidgetProps) => {
        ...
        return (
          <div
            ...
            className={`relative group h-8 w-8 text-sm flex items-center justify-center rounded-full transition-all duration-200 ${isBirthday
                ? "bg-gradient-to-br from-[#F59E0B]/20 to-[#B45309]/20 font-bold text-[#F59E0B] hover:from-[#F59E0B]/30 hover:to-[#B45309]/30"
                : "text-[#9CA3AF] hover:bg-[#2A2A2A]"
              } ${isToday
                ? "ring-2 ring-[#F59E0B] ring-offset-2 ring-offset-[#111111] bg-[#F59E0B]/10"
                : ""
              }`}
          >
            {day}
            {isBirthday && (
              <>
                <div className="absolute -top-1 -right-1 w-2 h-2 bg-[#F59E0B] rounded-full animate-pulse"></div>
                <div className="absolute z-50 hidden group-hover:block w-64 bg-[#111111] shadow-2xl rounded-xl p-4 left-1/2 top-full transform -translate-x-1/2 mt-2 border border-[#2A2A2A]">
                  <div className="flex items-center mb-3">
                    <Cake className="w-4 h-4 mr-2 text-[#F59E0B]" />
                  ...
                  <div className="space-y-2 max-h-48 overflow-y-auto custom-scrollbar">
                    {dayBirthdays.map((bday, idx) => (
                      <div
                        ...
                        className="p-2 bg-gradient-to-r from-[#F59E0B]/10 to-[#B45309]/10 rounded-lg border border-[#F59E0B]/20 animate-slide-up"
                        style={{ animationDelay: `${idx * 100}ms` }}
                      >
                        <div className="flex items-center">
                          <User className="w-3 h-3 mr-2 text-[#F59E0B]" />
                          <span className="font-semibold text-[#F9FAFB] truncate text-xs">{bday.name}</span>
                        </div>
                        <div className="flex items-center mt-1 ml-5">
                          <Phone className="w-3 h-3 mr-1 text-[#10B981]" />
                          <span className="text-[#9CA3AF] truncate text-xs">{bday.reg_mobile}</span>
                        </div>
                      </div>
                    ))}
                  </div>
  ...
  return (
    <div className="bg-[#111111] rounded-2xl shadow-xl border border-[#2A2A2A] overflow-visible">
      <div className="p-5">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-3">
            <div className="p-2 rounded-xl bg-gradient-to-r from-[#F59E0B] to-[#B45309]">
            ...
            <div>
              <h3 className="text-xl font-bold text-[#F9FAFB]">{monthName} {currentYear}</h3>
              <p className="text-sm text-[#9CA3AF]">Birthdays & Events</p>
            </div>
          </div>
          <Gift className="w-5 h-5 text-[#F59E0B] animate-bounce" />
        </div>

        <div className="mb-6">
          <div className="text-center">
            <div className="grid grid-cols-7 gap-1 text-xs mb-2 font-semibold text-[#9CA3AF]">
            ...
            {loading ? (
              <div className="grid grid-cols-7 gap-1 min-h-[168px]">
                {Array.from({ length: 42 }).map((_, i) => (
                  <div key={`skeleton-${i}`} className="animate-pulse h-8 bg-[#2A2A2A] rounded-lg"></div>
                ))}
              </div>
            ) : (
        ...
        {!loading && (
          <div className="mt-6">
            <div className="flex items-center justify-between mb-3">
              <h4 className="text-sm font-bold text-[#F9FAFB] flex items-center">
            ...
            {upcomingBirthdays.length > 0 ? (
                ...
                {upcomingBirthdays.map((birthday, index) => {
                  ...
                  return (
                    <div
                      ...
                      className="flex items-center p-3 bg-[#1F1A1A] rounded-xl border border-[#2A2A2A] hover:border-[#F59E0B]/50 hover:shadow-md transition-all duration-300 group"
                      style={{ animationDelay: `${index * 150}ms` }}
                    >
                      <div className="flex-shrink-0 w-10 h-10 rounded-xl bg-gradient-to-br from-[#F59E0B]/20 to-[#B45309]/20 border border-[#F59E0B]/30 flex items-center justify-center mr-3 text-xs font-bold text-[#F59E0B]">
                        {formattedDate}
                      </div>
                      <div className="flex-grow min-w-0">
                        <div className="flex items-center">
                          <h5 className="text-sm font-bold text-[#F9FAFB] truncate">{birthday.name}</h5>
                          {birthday.daysUntil <= 3 && (
                            <span className="ml-2 px-1.5 py-0.5 text-[10px] font-bold bg-gradient-to-r from-[#F59E0B] to-[#B45309] text-white rounded-full">
                              SOON
                            </span>
                          )}
                        </div>
                        <p className="text-xs text-[#9CA3AF] truncate mt-1">{birthday.reg_email}</p>
                      </div>
                      <div className="text-right">
                        <p className={`text-xs font-bold ${birthday.daysUntil === 0 ? 'text-[#F59E0B]' : 'text-[#10B981]'}`}>
              ...
              <div className="text-center py-6 bg-[#1F1A1A] rounded-xl text-sm text-[#9CA3AF]">
                <Cake className="w-8 h-8 mx-auto mb-2 text-[#2A2A2A]" />
    ...
    <div className="bg-[#111111] rounded-2xl shadow-xl border border-[#2A2A2A] p-6 h-full">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-[#F9FAFB]">Partner Profile</h2>
            <p className="text-sm text-[#9CA3AF]">Your business dashboard overview</p>
          </div>
        </div>
        {statsData.error && (
          <div className="px-3 py-1.5 rounded-lg bg-gradient-to-r from-[#F59E0B]/10 to-[#B45309]/10 border border-[#F59E0B]/30">
            <p className="text-xs text-[#F59E0B] font-medium">{statsData.error}</p>
          </div>
        )}
      </div>
      ...
      <div className="grid grid-cols-1 gap-3 mb-6">
        {[
          { icon: Mail, label: "Email", value: statsData.loading ? "..." : statsData.email, color: "text-[#F59E0B]" },
          { icon: Phone, label: "Mobile", value: statsData.loading ? "..." : statsData.mobile, color: "text-[#10B981]" },
          { icon: CreditCard, label: "PAN", value: statsData.loading ? "..." : statsData.pan, color: "text-[#F59E0B]" },
          { icon: Award, label: "Partner ID", value: partnerRegId || "Not found", color: "text-[#F59E0B]" }
        ].map((item, idx) => (
          <div
            key={idx}
            className="bg-[#1F1A1A] rounded-lg border border-[#2A2A2A] p-3 hover:shadow-md transition-all duration-300 group hover:border-[#F59E0B]/50"
            style={{ animationDelay: `${idx * 100}ms` }}
          >
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <p className="text-sm font-bold text-[#F9FAFB] truncate">{item.value}</p>
              </div>
            </div>
          </div>
        ))}
  ...
  return (
    <div className="bg-[#111111] rounded-2xl shadow-xl border border-[#2A2A2A] p-6 h-full">
      <div className="flex items-center space-x-3 mb-6">
        ...
        <div>
          <h2 className="text-xl font-bold text-[#F9FAFB]">Business Overview</h2>
          <p className="text-sm text-[#9CA3AF]">Key performance metrics</p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        {stats.map((stat, idx) => (
          <div
            key={idx}
            className={`relative group ${stat.bgColor} rounded-xl border border-[#2A2A2A] p-4 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-0.5`}
          ...
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center space-x-3">
                ...
                <div className="flex items-center space-x-1 bg-gradient-to-r from-[#10B981]/10 to-[#059669]/10 px-2 py-1 rounded-lg">
...
const MutualFundPerformance = () => {
  ...
  if (loading) {
    return (
      <div className="bg-[#111111] rounded-2xl shadow-xl border border-[#2A2A2A] p-6">
        <div className="space-y-4">
          {[...Array(5)].map((_, i) => (
            <div key={i} className="animate-pulse">
              <div className="h-16 bg-gradient-to-r from-[#2A2A2A] via-[#3A3A3A] to-[#2A2A2A] rounded-xl animate-shimmer bg-[length:200%_100%]"></div>
            </div>
          ))}
        </div>
      </div>
  ...
  if (error) {
    return (
      <div className="bg-[#111111] rounded-2xl shadow-xl border border-[#EF4444]/30 p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-[#9CA3AF]">Based on 1-year returns</p>
          </div>
        </div>
        <button
          onClick={() => router.push('/mutual-fund')}
          className="px-4 py-2 rounded-lg bg-gradient-to-r from-[#F59E0B]/10 to-[#B45309]/10 text-[#F59E0B] hover:shadow-lg transition-all duration-300 text-sm font-semibold border border-[#F59E0B]/30 hover:border-[#F59E0B]"
        >
          View All →
        </button>
      </div>
      ...
      <div className="space-y-4">
        {funds.slice(0, 5).map((fund, index) => {
          ...
          return (
            <div
              key={fund.id}
              className="group relative bg-[#1F1A1A] rounded-xl border border-[#2A2A2A] p-4 hover:border-[#F59E0B]/50 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-0.5"
              style={{ animationDelay: `${index * 100}ms` }}
            >
              <div className={`absolute left-0 top-0 h-full w-1 ${isPositive ? 'bg-gradient-to-b from-[#10B981] to-[#059669]' : 'bg-gradient-to-b from-[#EF4444] to-[#DC2626]'}`}></div>

              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  <div className="relative">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#F59E0B]/20 to-[#B45309]/20 flex items-center justify-center">
                      <Icon className="w-6 h-6 text-[#F59E0B]" />
                    </div>
                    {index < 3 && (
                      <div className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-gradient-to-r from-[#F59E0B] to-[#B45309] flex items-center justify-center">
                ...
                <div className="text-right">
                  <div className="flex items-center justify-end space-x-2">
                    ...
                    <div
                      className={`font-bold text-lg ${isPositive ? 'text-[#10B981]' : 'text-[#EF4444]'
                        }`}
                    >
                      {isPositive ? '+' : ''}
                  ...
                  <div className="flex items-center justify-end mt-2">
                    {[...Array(5)].map((_, i) => (
                      <span
                        key={i}
                        className={`text-sm ${i < rating ? 'text-[#F59E0B]' : 'text-[#2A2A2A]'
                          }`}
                      >
                        ★
                      </span>
                    ))}
                    <span className="text-xs text-[#9CA3AF] ml-1">({rating}.0)</span>
                  </div>
                </div>
              </div>
            </div>
...
const PartnerDashboardComponent = () => {
  ...
  return (
    <div className="flex w-full min-h-screen bg-[#0A0A0A] m-0 p-0">
      <style jsx global>{`
        @keyframes slide-in {
          from {
...
export default function Home() {
  ...
  return (
    <div className="flex h-screen w-full bg-[#0A0A0A]" data-theme="light">
      ...
      <div
        className={`fixed z-50 top-0 h-screen bg-[#0A0A0A] lg:hidden transition-all duration-300 ease-in-out ${sidebarCollapsed ? "left-[-100%]" : "left-0 w-[288px]"
          }`}
      >
        <Sidebar toggleSidebar={toggleSidebar} collapsed={sidebarCollapsed} />
      </div>

      <main className="flex flex-col flex-1 overflow-hidden bg-[#0A0A0A] lg:rounded-l-3xl shadow-2xl w-full">
        <Header
