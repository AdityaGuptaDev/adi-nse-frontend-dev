...
export default function NseKycStatus() {
  ...
  return (
    <div className="p-6 max-w-[700px] mx-auto">
      <h1 className="text-2xl font-bold text-gray-800 mb-6">KYC Status Check</h1>
      ...
      <div className="bg-white rounded-xl shadow-sm border p-6 mb-6">
        ...
        <div className="flex gap-3">
          <input
            ...
            maxLength={10}
            className="border rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#4bc5c1] flex-1 uppercase tracking-wider"
