    ...
    <div className="nse-module p-4 md:p-6">
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-5">
        <div className="flex-1">
          <label className="text-xs text-gray-500 font-medium mb-1 block">Scheme</label>
      ...
      <div className="flex items-center gap-4 mb-3 text-xs text-gray-500">
        <span>Total: <strong className="text-gray-800">{filteredSchemes.length}</strong> schemes</span>
        {totalPages > 1 && (
          <span>Page <strong className="text-gray-800">{page}</strong> of <strong className="text-gray-800">{totalPages}</strong></span>
        )}
      </div>
            ...
            {loading ? (
              ...
              paginatedSchemes.map((scheme, idx) => (
                <tr key={scheme.scheme_code || idx} className="hover:bg-gray-50/50 transition-colors">
                  ...
                  <td className="px-4 py-3 text-gray-600 text-xs">{scheme.sub_category || "--"}</td>
        ...
        <div className="flex items-center justify-between mt-4 text-sm">
          ...
          <div className="flex items-center gap-1">
            <button
              ...
              className="px-3 py-1.5 rounded-lg border border-gray-200 text-xs font-medium disabled:opacity-40 disabled:cursor-not-allowed hover:bg-gray-50"
            >
              Previous
            </button>
